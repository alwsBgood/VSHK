...
$database = "allinsol_reg"; // БД*/
 $db_host = "ramok.mysql.ukraine.com.ua";
$db_user = "ramok_prschool"; // Логин БД
$db_password = "vjhdwq9m"; // Пароль БД
$database = "ramok_prschool"; // БД
...
$name = getVar('entry_583196713');
$phone = getVar('entry_1805884529');
$email = getVar('entry_1596947982');
